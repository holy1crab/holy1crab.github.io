...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var d3_selection_1 = __webpack_require__(2);
	var linear_chart_1 = __webpack_require__(3);
	var util = __webpack_require__(15);
	function generate(fileSize, intervalRange, callback) {
	...
	var DataElement = (function () {
	    ...
	    DataElement.prototype.getX = function () {
	        return this.x;
	    };
	    DataElement.prototype.getY = function () {
	        return this.y;
	    };
	    return DataElement;
	}());
	function main() {
	    ...
	    var svg = d3_selection_1.select(svgEl)
	        .attr('width', width)
	        .attr('height', height);
	    var cont = svg.append('g').attr('transform', 'translate(30,10)');
	    var chart = new linear_chart_1.LinearChart(cont, {
	    ...
	    generate(fileSize, [50, 100], function (size) {
	        totalSizeEmit += size;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var d3_scale_1 = __webpack_require__(4);
	var d3_shape_1 = __webpack_require__(12);
	var d3_axis_1 = __webpack_require__(14);
	var LinearChart = (function () {
	    function LinearChart(container, options) {
	        var _this = this;
	        this.data = [];
	        this.container = container;
	        this.options = options;
	        this.maxY = options.maxY || 0;
	        this.xScale = d3_scale_1.scaleLinear().domain([0, options.maxX]).range([0, this.options.width]);
	        this.yScale = d3_scale_1.scaleLinear().domain([0, this.maxY]).range([this.options.height, 0]);
	        this.chartLine = d3_shape_1.line()
	            .x(function (d) { return _this.xScale(d.getX()); })
	            .y(function (d) { return _this.yScale(d.getY()); })
	            .curve(d3_shape_1.curveCatmullRom.alpha(0.1));
	    }
	    LinearChart.prototype.drawGrid = function () {
	    ...
	    LinearChart.prototype.init = function () {
	        var xAxis = d3_axis_1.axisBottom(this.xScale);
	        var yAxis = d3_axis_1.axisLeft(this.yScale);
	    ...
	    LinearChart.prototype.getLast = function () {
	        return this.data[this.data.length - 1];
	    };
	    LinearChart.prototype.update = function () {
	        var _this = this;
	        if (!this.data.length) {
	            return;
	        }
	        this.path.attr('d', function (d) { return _this.chartLine(d) + ' V ' + _this.options.height + ' H0 Z'; });
	        var y = this.yScale(this.getLast().getY());
	        this.horizontalLine.attr('transform', 'translate(0, ' + y + ')');
	    };
	    LinearChart.prototype.addData = function (value) {
	        this.data.push(value);
	        if (!this.options.maxY && value.getY() > this.maxY) {
	            this.maxY = value.getY();
	            this.yScale.domain([0, this.maxY * 1.1]);
	            this.yAxisContainer.call(d3_axis_1.axisLeft(this.yScale));
	        }
	    };
	    return LinearChart;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? factory(exports, __webpack_require__(5), __webpack_require__(6), __webpack_require__(7), __webpack_require__(9), __webpack_require__(10), __webpack_require__(11), __webpack_require__(8)) :
